...
class PriorityQueueTest {
    ...
    fun testPriorityQueueCustomObjects() {
        ...
        queue2.add(Task(2, "Medium priority3"))
        ...
        assertEquals(Task(2, "Medium priority3"), queue2.peek())
        assertEquals(Task(2, "Medium priority3"), queue2.poll())
        ...
        queue3.add(Task(2, "Medium priority3"))
        ...
        assertEquals(Task(2, "Medium priority3"), queue3.peek())
        assertEquals(Task(2, "Medium priority3"), queue3.poll())
