...
fun String.isSemVer(): Boolean {
    return semverPattern.matches(this)
}

fun String.matchesSemVerPattern(pattern: String): Boolean {
    return SemVerMatcher.matcher(pattern).matches(SemVer.create(this))
}

fun String.asSemVer(): SemVer {
    return SemVer.create(this)
}

fun String.compareSemVer(b: String): Int {
    return SemVer.create(b).compareTo(SemVer.create(this))
}
